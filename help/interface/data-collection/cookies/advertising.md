...
>[!NOTE]
>
>La etiqueta beta Adobe Advertising Javascript que usa el servicio [Adobe Experience Cloud ID (ECID)](https://experienceleague.adobe.com/docs/id-service/using/intro/overview.html?lang=es) crea cookies de origen [Experience Cloud](experience-cloud.md) `s_ecid`, no cookies de Adobe Advertising.
