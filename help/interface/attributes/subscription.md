...
Por ejemplo, la suscripción de Adobe Analytics permite los datos de atributos en los informes. Si utiliza Adobe Destinatario, puede cargar Atributos del cliente para objetivos y segmentación.
