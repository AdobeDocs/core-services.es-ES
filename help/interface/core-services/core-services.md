...
seo-title: Activación de las soluciones de Experience Cloud para los servicios principales
...
>[!NOTE]
>
>Para Target [, migre a at. js desde mbox. js](https://marketing.adobe.com/resources/help/en_US/target/ov2/t_target-migrate-atjs.html).
...
1. Tener un Adobe ID.
1. Inicie sesión en [!DNL marketing.adobe.com].
...
> [!NOTE]
> 
> Una vez asignados los grupos de soluciones y Enterprise, los usuarios nuevos se vinculan automáticamente. (las credenciales de la solución se crean automáticamente y se vinculan a su Adobe ID).
...
* Llama al `visitor.setCustomerIDs({"crm_id":"52mc210tr42"})` servicio de ID de visitante. O bien,
...
Consulte *la sección del servicio* Experience Cloud ID para ver ejemplos de sintaxis sobre cómo establecer ID de cliente adicionales en [aplicaciones móviles Android](https://marketing.adobe.com/resources/help/en_US/mobile/android/?f=methods) e [iOS](https://marketing.adobe.com/resources/help/en_US/mobile/ios/?f=methods) .
...
Se le recomienda modernizar su implementación de Analytics mediante la actualización de sus bibliotecas de JavaScript, incluido el API de visitante. La manera sencilla de lograrlo es agregar una [!DNL Adobe Analytics] herramienta en Administración dinámica de etiquetas, especificando *`Automatic`* como método de configuración.

En la administración dinámica de etiquetas, haga clic en **[!UICONTROL <Web Property Name>]**&gt;**[!UICONTROL Información general]**&gt;**[!UICONTROL Agregar una herramienta]**&gt;**[!UICONTROL Adobe Analytics]**. Consulte[Configuración de Adobe Analytics](https://marketing.adobe.com/resources/help/en_US/dtm/?f=analytics_dtm)en la Dynamic Tag Management para obtener información de implementación.
...
1. Borre las cookies de su sitio para ver la solicitud al servicio Experience Cloud ID (la solicitud se realiza en la primera visita y, a continuación, una vez por visitante y semana).1. Using a packet analyzer or the network panel in a web browser debugger, look for a request going to [!DNL dpm.demdex.net].
1. Compruebe que la respuesta contiene `d_mid` y un valor, por ejemplo: `_setMarketingCloudFields({"d_mid":"4235...`
...
Una vez que esté en marcha, vaya a **[!UICONTROL Administración]** &gt; **[!UICONTROL Iniciar Admin Console]**, donde podrá administrar usuarios y perfiles de producto.
...
**Personas &gt; Atributos del cliente**
...
**Personas &gt; Biblioteca de audiencias**
...
* Se instala la cookie de demdex.net si no están bloqueadas las cookies de terceros. La cookie propia `AMCV_###@AdobeOrg` siempre se instala con el ID de Experience Cloud (anteriormente, el servicio ID de visitante).
