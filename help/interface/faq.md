...
Si su implementación no se ha aprovisionado para servicios principales, consulte [Habilitar las aplicaciones para los servicios principales](core-services.md#concept_07ED1D5C64234E77976E6D572E78FB9C), que describe cómo:
...
La funcionalidad proporcionada por la interfaz de Experience Cloud añade un nuevo valor a su negocio. También es la ruta estándar para acceder a las aplicaciones a partir de ahora, y con el tiempo sustituye otros flujos de inicio de sesión de aplicaciones individuales. El inicio de sesión a través de Experience Cloud facilita una transición más fluida posteriormente.
...
* Los usuarios pueden empezar a iniciar sesión en [!DNL Experience Cloud] y vinculación de aplicaciones.
* Pueden empezar a utilizar las funcionalidades disponibles a través de Experience Cloud, como People.
* Puede prepararse para retirar el proceso de inicio de sesión específico de la aplicación.
* Puede conservar el control de acceso a las aplicaciones.
...
Consulte [Vinculación de una cuenta de aplicación a un Adobe ID](organizations.md#task_FD389E78640848919E247AC5E95B8369).
...
Su acceso debe eliminarse de la propia aplicación. No podrán acceder al producto desde Experience Cloud ni a través del inicio de sesión directo. También debe eliminarlos en el nivel de Experience Cloud.
