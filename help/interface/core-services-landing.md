...
Para acceder a estos servicios en el Experience Cloud, haga clic en **[!UICONTROL Application Selector]**
...
| [People: Atributos del cliente](attributes.md) | Cree casos de uso de orquestación en tiempo real utilizando datos contextuales almacenados en eventos o fuentes de datos. [!UICONTROL Journey Orchestration] es un servicio de aplicaciones integrado en Experience Platform. |
