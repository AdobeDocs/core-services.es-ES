---
description: Obtenga información sobre las integraciones de aplicaciones disponibles en Adobe Experience Cloud.
...
Comparta carpetas y recursos entre Experience Cloud y Creative Cloud. Colabore, realice anotaciones en recursos compartidos y utilícelos en aplicaciones de Experience Cloud como [!DNL Social] y [!DNL Target].
...
Trabaje con datos de aplicaciones de Experience Cloud u otros sistemas externos en Audience Manager.
...
* [Integración de datos de Adobe Target](https://experienceleague.adobe.com/docs/audience-manager/user-guide/implementation-integration-guides/integration-other-applications/aam-target-integration.html?lang=en)
...
Utilice las aplicaciones Activation de Experience Cloud para configurar y depurar las aplicaciones de Experience Cloud.
...
* [Servicio de ID de MAC](https://experienceleague.adobe.com/docs/experience-platform/tags/home.html?lang=en)
* [Seguimiento de Nielsen](https://experienceleague.adobe.com/docs/experience-platform/tags/home.html?lang=en)
...
Integre Adobe Target con Adobe Analytics y otras aplicaciones de Experience Cloud para permitir el uso de los mismos datos, audiencias, atributos y métricas en ambas aplicaciones.
