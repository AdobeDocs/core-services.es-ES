---
description: Obtenga más información sobre las fuentes de datos de soluciones y de la configuración de suscripciones. Las suscripciones permiten el flujo de datos de Atributos del cliente entre el Experience Cloud y las soluciones (Analytics y Target).
