---
description: Obtenga más información sobre las fuentes de datos de soluciones y de la configuración de suscripciones. Las suscripciones permiten el flujo de datos de Atributos del cliente entre el Experience Cloud y las aplicaciones (Analytics y Target).
...
Obtenga información sobre las fuentes de datos de la aplicación y la configuración de suscripciones. Las suscripciones permiten el flujo de datos de Atributos del cliente entre el Experience Cloud y las aplicaciones ([!DNL Analytics] y [!DNL Target]).
...
| Atributos para incluir (Analytics y [!DNL Target]) | Los atributos que desea enviar a la aplicación. <br>Al configurar suscripciones y seleccionar atributos, se aplican los límites siguientes _por grupo de informes,_ según las aplicaciones que posea:<ul><li>Foundation: 0</li><li>Select: 3</li><li>Prime: 15</li><li>Ultimate: 200</li><li>Standard: 3 en total</li><li>Premium: 200 por grupo de informes</li><li>[!DNL Target] Standard: 5</li><li>[!DNL Target] Premium: 200</li></ul><br>**Nota:** Cuando actualice a Analytics Premium, no podrá disponer de los atributos adicionales hasta haber transcurrido 24 horas. Durante este periodo, puede aparecer el error Máximas suscripciones a atributos. |
