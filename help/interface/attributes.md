...
description: Obtenga información sobre los Atributos del cliente en Experience Cloud. Descubra cómo cargar datos de atributos del cliente para utilizarlos en Adobe Analytics y Adobe Target.
