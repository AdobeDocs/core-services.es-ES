...
* Si utiliza [!DNL Analytics] identificadores heredados (también conocidos como la cookie `s_vi` ), dependerá de cómo haya configurado el servidor de recopilación de datos. Si el servidor de recopilación de datos coincide con el dominio del sitio, las cookies se establecen como propias. Si el servidor de recopilación no coincide con su dominio actual, las cookies se establecen como terceros. En este caso, si se bloquean las cookies de terceros, [!DNL Analytics] establece un [id de reserva de origen (&quot;s_fid&quot;)](https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-analytics.html?lang=en#section-65e33f9bfc264959ac1513e2f4b10ac7) en lugar de la cookie estándar &quot;s_vi&quot;.
