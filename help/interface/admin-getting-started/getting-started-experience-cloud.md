...
|--- |--- |
| [Conceptos básicos de Admin Console](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html) | Obtenga información sobre los pasos iniciales que debe seguir para empezar a utilizar las soluciones de Experience Cloud. |
...
| [Gestionar usuarios de Creative Cloud](../experience-cloud-assets/t-admin-add-cc-user.md) | Recursos de Experience Cloud permite a los especialistas en marketing compartir, sincronizar y colaborar en carpetas con diseñadores y otros recursos creativos mediante el Creative Cloud. Aquí puede administrar los usuarios de Creative Cloud aprobados para colaborar con su organización. |
...
1. Compruebe con su administrador que su [organización](../admin-getting-started/organizations.md) está aprovisionada en Experience Cloud.
...
| destURL | Dirección URL completa del lugar al que se debe llevar al usuario. | https://sc.omniture.com/login?r=%2Fx%2F1_7xxzf&amp;tenantId=obuengsc&amp;company=OBU+Eng+SC | Opcional |
