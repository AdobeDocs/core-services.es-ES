...
Como alternativa, en el menú Experience Cloud ( ![](assets/menu-icon.png)), haga clic **[!UICONTROL en Administración]** &gt; **[!UICONTROL Iniciar Admin Console]**.
...
La migración de cuentas se está poniendo a disposición de los clientes por fases. Adobe le notificará y le asistirá cuando desee migrar las cuentas de usuario existentes de Herramientas **[!UICONTROL de administración]** &gt; **[!UICONTROL Administración]** de usuarios a Admin Console.
...
## Campaña: perfiles de producto, inquilinos y grupos de seguridad {#section_09CDF75366444CF5810CF321B7C712F3}
...
Consulte [Administración de grupos y usuarios](https://helpx.adobe.com/campaign/standard/administration/using/managing-groups-and-users.html) para obtener información sobre los grupos de seguridad y asignar usuarios a los grupos de seguridad.

## Experience Platform Launch {#section_F2DA6778DD2D48AA8F794041971EE6B1}

Launch, de Adobe, se muestra en la página Productos de Admin Console. Puede incluir otras soluciones y servicios principales en un perfil de producto de Launch.

Consulte [Administración](https://marketing.adobe.com/resources/help/en_US/experience-cloud/launch/user-management.html) de usuarios para obtener información sobre permisos de usuario en Admin Console y configurar opciones específicas de Launch, incluida la asignación de derechos a perfiles.
...
Consulte [Usuarios y permisos](https://marketing.adobe.com/resources/help/en_US/dtm/users.html) para obtener información sobre cómo invitar a usuarios a Administración dinámica de etiquetas, asignar funciones de usuario y agregar usuarios a grupos.
...
1. Haga clic **[!UICONTROL en Nuevo perfil]**.
1. Configure los detalles del perfil y haga clic **[!UICONTROL en Siguiente]**.
...
1. En el perfil de producto, haga clic **[!UICONTROL en Permisos]** (disponible sólo para administradores).
...
| Herramientas de Analytics | Habilite permisos de usuario para elementos generales (facturación, registros, etc.), administración de la empresa, herramientas, acceso a servicios web, Report Builder e integración de Data Connectors. La configuración de empresa de la categoría Personalizar Consola de administración se ha trasladado a Herramientas de Analytics. |
...
1. En Admin Console, haga clic **[!UICONTROL en Usuarios]** y, a continuación, haga clic en el nombre del usuario.
1. Haga clic **[!UICONTROL en Editar derechos de administrador]**.
1. Configure los derechos de administración del usuario.
1. Haga clic **[!UICONTROL en Siguiente]** para revisar la configuración y, a continuación, haga clic **[!UICONTROL en Guardar]**.
