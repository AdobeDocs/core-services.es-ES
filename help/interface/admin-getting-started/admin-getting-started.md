...
[Guía de usuario de administración](https://helpx.adobe.com/es/enterprise/using/users.html) para Creative Cloud y Document Cloud. Existe información relevante para la administración de usuarios de Experience Cloud, como [administrar los tipos de identidad](https://helpx.adobe.com/es/enterprise/help/identity.html).
...
[Migración de ID de usuario en Analytics](https://marketing.adobe.com/resources/help/es_ES/experience-cloud/admin-console/analytics-migration/)
...
Consulte:
* [Permisos de usuario de Enterprise](https://marketing.adobe.com/resources/help/es_ES/target/target/?f=property_channel)
* [Administrar productos y perfiles](https://helpx.adobe.com/es/enterprise/using/manage-products-and-profiles.html)
* Vídeo: [Configurar espacios de trabajo de Target en Adobe Admin Console](https://helpx.adobe.com/es/target/kb/how-to-configure-target-workspaces-in-adobe-admin-console0.html)
...
Consulte [Administración de grupos y usuarios](https://helpx.adobe.com/es/campaign/standard/administration/using/managing-groups-and-users.html) para obtener información sobre los grupos de seguridad y asignar usuarios a los grupos de seguridad.
...
Consulte [Gestión de usuarios](https://marketing.adobe.com/resources/help/en_US/experience-cloud/launch/?f=user-management) para obtener información sobre permisos de usuario en Admin Console y configurar opciones específicas de Experience Platform Launch, como la asignación de derechos a perfiles.
...
Consulte [Usuarios y permisos](https://marketing.adobe.com/resources/help/es_ES/dtm/?f=users) para obtener información sobre cómo invitar a usuarios a Dynamic Tag Management, asignar funciones de usuario y agregar usuarios a grupos.
...
Consulte [Administración](https://marketing.adobe.com/resources/help/en_US/aam/?f=c_administration) en la ayuda de Audience Manager.
...
* [Administración de productos y perfiles](https://helpx.adobe.com/es/enterprise/using/manage-products-and-profiles.html)
* [Permisos de usuario de Enterprise](https://marketing.adobe.com/resources/help/es_ES/target/target/?f=property_channel) en la asistencia de Target para obtener más información.
* Vídeo: [Configurar espacios de trabajo de Target en Adobe Admin Console](https://helpx.adobe.com/es/target/kb/how-to-configure-target-workspaces-in-adobe-admin-console0.html)
...
* Última versión de Internet Explorer de Microsoft. (Microsoft ha [finalizado la asistencia](https://www.microsoft.com/es-es/WindowsForBusiness/End-of-IE-support) para Internet Explorer 8, 9 y 10. Por este motivo, Adobe no corregirá los problemas notificados en relación con estas versiones específicas de Internet Explorer).
* Google Chrome
* Mozilla Firefox
* Apple Safari
...
* [Analysis Workspace y Reports &amp; Analytics](https://marketing.adobe.com/resources/help/es_ES/sc/user/?f=requirements) (incluye Adobe Social)
* [Report Builder](https://marketing.adobe.com/resources/help/es_ES/arb/?f=system_requirements)
* [Ad Hoc Analysis](https://marketing.adobe.com/resources/help/es_ES/dsc/index.html?f=c_sys_reqs)
* [Data Workbench](https://marketing.adobe.com/resources/help/en_US/insight/install/?f=c_Data_Workbench_Client_install)
* [Adobe Target](https://marketing.adobe.com/resources/help/es_ES/target/ov/?f=r_supported_browsers)
* [Adobe Audience Manager](https://marketing.adobe.com/resources/help/en_US/aam/?f=c_supported_browsers)
* [Adobe Campaign Standard](https://helpx.adobe.com/es/campaign/standard/start/using/compatible-browsers.html)
* [Adobe Campaign Classic](https://helpx.adobe.com/es/campaign/kb/compatibility-matrix.html)
