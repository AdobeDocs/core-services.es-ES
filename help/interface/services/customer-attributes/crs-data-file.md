...
# Fuentes y archivos de datos de Atributos del cliente

Requisitos de archivos de datos y varios orígenes de datos para cargar datos de atributos del cliente en CX Enterprise.

Necesita acceso a CRM o datos similares de su empresa. Los datos que cargue en CX Enterprise deben ser un archivo de `.csv`. Si carga a través de un FTP o sFTP, también debe subir un archivo `.fin`.
...
<table id="table_A9849CC9AA784763921DE057F0F61515"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Puede cargar cientos de <span class="filepath"> columnas .csv </span> en el servicio de atributos del cliente en CX Enterprise. Sin embargo, al configurar suscripciones y seleccionar atributos, se aplican los límites siguientes según las aplicaciones que tenga: </p> <p> 
