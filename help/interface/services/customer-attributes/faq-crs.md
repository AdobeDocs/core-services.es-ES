...
| ¿Se requiere la migración al Servicio de Experience Cloud ID? | La migración depende de las aplicaciones que utilice. <ul><li>Adobe Analytics: Recomendado </li><li>Adobe Target: Necesario. </li></ul>El uso del servicio Experience Cloud ID permite la funcionalidad de Experience Cloud más reciente, incluidas las audiencias en tiempo real, la modernización de Adobe Target, la integración de Analytics y el seguimiento de Video Heartbeat. |
