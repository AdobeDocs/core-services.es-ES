...
Obtenga más información acerca de las fuentes de datos de aplicaciones y de la configuración de suscripciones. Las suscripciones habilitan el flujo de datos de [!DNL Customer Attribute] entre el Experience Cloud y las aplicaciones ([!DNL Analytics] y [!DNL Target]).
