...
* Las audiencias en tiempo real provienen de CX Enterprise Audiences y se evalúan en tiempo real.
...
| Campaign | <ul><li>Importe audiencias compartidas de diferentes aplicaciones empresariales de Adobe CX en Adobe Campaign.</li><li>Exportación de listas de destinatarios como públicos compartidos. Estas audiencias compartidas pueden utilizarse con las distintas aplicaciones empresariales de Adobe CX que utilice.</li></ul> |
...
**[!UICONTROL CX Enterprise]** > **[!UICONTROL Experience Platform]** > **[!UICONTROL Personas]** > **[!UICONTROL Biblioteca de audiencias]**
...
| Fuente | Identifica dónde se creó el público.<ul><li>**Analytics:** Un segmento creado en Adobe Analytics y publicado en CX Enterprise.</li><li>**CX Enterprise:** Una nueva audiencia [creada en CX Enterprise Audiences](https://experienceleague.adobe.com/es/docs/core-services/interface/services/audiences/create).</li><li>**Audience Manager:** Las audiencias creadas por Audience Manager se muestran automáticamente en las audiencias de CX Enterprise.</li></ul> |
