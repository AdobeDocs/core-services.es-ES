...
Para obtener la ayuda completa del Servicio de CX Enterprise ID (anteriormente conocido como ID de visitante), ve [aquí](https://experienceleague.adobe.com/docs/id-service/using/intro/overview.html#intro).
...
Como parte de la configuración del servicio CX Enterprise ID, Adobe recomienda (para Analytics y [!DNL Target]) que sincronice los [ID de cliente](https://experienceleague.adobe.com/docs/id-service/using/reference/authenticated-state.html) con CX Enterprise.
