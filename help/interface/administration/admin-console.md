...
| Vínculo de ayuda | Descripción |
| ------- | ------- |
| [Restablecer tu Adobe ID](https://helpx.adobe.com/es/manage-account/kb/account-password-sign-help.html) | Cierre la sesión y haga clic en **[!UICONTROL Obtener ayuda para iniciar sesión]** > **[!UICONTROL Restablecer la contraseña]**. |
...
| [!DNL Pass] | [Get started with Account IQ](https://experienceleague.adobe.com/es/docs/pass/aiq-help/get-started) |
...
* [Advertising Search, Social y Commerce](https://experienceleague.adobe.com/es/docs/advertising/search-social-commerce/new-ui/user-administration)
...
* [Adobe Pass](https://experienceleague.adobe.com/es/docs/pass/aiq-help/get-started)
