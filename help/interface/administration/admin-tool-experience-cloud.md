...
1. En [!UICONTROL Acceso rápido], haga clic en **[!UICONTROL Herramienta de administración]**.
   ...
   Se muestra la página [!UICONTROL Usuarios].
...
| [!UICONTROL Soluciones] | Resumen de las aplicaciones empresariales de CX a las que el usuario puede acceder. Puede aplicar filtros para reducir la lista de los usuarios con acceso específico a la aplicación. |
...
| Filtro [!UICONTROL Tipo de identificador] | Elija entre los tipos de ID disponibles. Se pueden usar varios tipos de ID como filtro. |
...
| Elemento | Descripción |
| ---------| ----------|
| Filtro [!UICONTROL Instancia] | Busque cadenas de caracteres en la columna de instancia para reducir los resultados a una o varias instancias. Añada varios filtros pulsando Intro después de cada término de búsqueda. |
| Filtro [!UICONTROL Solución] | Elija entre las aplicaciones disponibles. Varios filtros de aplicación buscan resultados que contengan Solución 1 `OR` Solución 2. |
