...
source-git-commit: 34be836bc7b5b4bd8a3a2d18fb2a8750ef271d87
workflow-type: tm+mt
...
|------------------|-------------------------|------------------|---------------------------|
| [Adobe GenStudio for Performance Marketing](#gspm) | GenStudio para marketing de rendimiento es una aplicación de IAgen. Ayuda a los equipos creativos y de marketing a crear contenido personalizado y sin marca. | No aplicable | Sí |
| [Adobe Experience Manager Sites](#aem) | GenAI se usa en [Generar variaciones](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor?lang=en) para crear variaciones de contenido basadas en la entrada. | No aplicable | Sí |
| [Sites Optimizer](#aem) | GenAI le ayuda a analizar y mejorar el rendimiento y la eficacia de las experiencias web. | No aplicable | No |
...
| [Adobe Journey Optimizer](#journey-optimizer) | No aplicable | Disponible para obtener conocimientos del producto y perspectivas operativas. | No |
...
| [[!DNL Adobe Journey Optimizer] B2B edition](#ajo-b2b) | No aplicable | Disponible para ayudarle con el conocimiento del producto. | No |
| [[!DNL Campaign] Servicios administrados en la nube](#campaign-cs) | No aplicable | Disponible para que el acelerador de contenido genere automáticamente contenido personalizado, atractivo y eficaz en función de los objetivos de marketing en canales como correo electrónico, SMS y push | Sí |
...
| [[!DNL Real-Time CDP]](#rtcdp) | No aplicable | Disponible para obtener información sobre el producto en Experience League. También ofrece perspectivas operativas (en versión beta). | No |
...
| [[!DNL Workfront]](#workfront) | GenAI se usa con información y sugerencias de [en la aplicación](https://experienceleague.adobe.com/en/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en). | No aplicable | Sí |
