...
| **Adobe Experience Manager Sites** | GenAI se usa en [Generar variaciones](https://experienceleague.adobe.com/es/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor?lang=en) para crear variaciones de contenido basadas en la entrada. | No aplicable | Sí | [!BADGE Más información]{type=Informative url="https://experienceleague.adobe.com/es/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor" tooltip="Vaya a Generar variaciones en Experience League"} |
| **Sites Optimizer** | GenAI le ayuda a analizar y mejorar el rendimiento y la eficacia de las experiencias web. | No aplicable | No | [!BADGE Más información]{type=Informative url="https://experienceleague.adobe.com/es/docs/experience-manager-sites-optimizer/content/opportunity-types/overview" tooltip="Vaya a Sites Optimizer en Experience League"} |
| **Adobe Experience Manager Assets** | GenAI se usa en [Content Hub](https://experienceleague.adobe.com/es/docs/experience-manager-cloud-service/content/assets/content-hub/product-overview?lang=en) y en [etiquetas inteligentes](https://experienceleague.adobe.com/es/docs/experience-manager-cloud-service/content/assets/manage/smart-tags?lang=en#ai-smart-tags) generadas por IA. | No aplicable | Sí | [!BADGE Más información]{type=Informative url="https://experienceleague.adobe.com/es/docs/experience-manager-cloud-service/content/assets/content-hub/product-overview" tooltip="Vaya a Content Hub en Experience League"} |
...
| **[!DNL Workfront]** | GenAI se usa con información y sugerencias de [en la aplicación](https://experienceleague.adobe.com/es/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en). | No aplicable | Sí | [!BADGE Más información]{type=Informative url="https://experienceleague.adobe.com/es/docs/workfront/using/basics/ai-assistant/ai-assistant-overview" tooltip="Obtenga información sobre el asistente de IA en Workfront"} |
