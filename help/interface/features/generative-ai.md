...
source-git-commit: 7d66d2e56c176eb631d232f2e57f22e19d17fe6d
workflow-type: tm+mt
...
| **Nombre de producto** | **IA generativa** | **Asistente de IA** | **Compatibilidad de Firefly** | Recursos |
|------------------|-------------------------|------------------|-------------------|------------|
| **Adobe GenStudio for Performance Marketing** | GenStudio para marketing de rendimiento es una aplicación de IAgen. Ayuda a los equipos creativos y de marketing a crear contenido personalizado y sin marca. | No aplicable | Sí | [!BADGE Más información]{type=Informative url="https://experienceleague.adobe.com/es/docs/genstudio-for-performance-marketing/user-guide/home" tooltip="Ir a GenStudio for Performance Marketing"} |
| **Adobe Experience Manager Sites** | GenAI se usa en [Generar variaciones](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor?lang=en) para crear variaciones de contenido basadas en la entrada. | No aplicable | Sí | [!BADGE Más información]{type=Informative url="https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor" tooltip="Vaya a Generar variaciones en Experience League"} |
| **Sites Optimizer** | GenAI le ayuda a analizar y mejorar el rendimiento y la eficacia de las experiencias web. | No aplicable | No | [!BADGE Más información]{type=Informative url="https://experienceleague.adobe.com/en/docs/experience-manager-sites-optimizer/content/opportunity-types/overview" tooltip="Vaya a Sites Optimizer en Experience League"} |
| **Adobe Experience Manager Assets** | GenAI se usa en [Content Hub](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/content-hub/product-overview?lang=en) y en [etiquetas inteligentes](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/manage/smart-tags?lang=en#ai-smart-tags) generadas por IA. | No aplicable | Sí | [!BADGE Más información]{type=Informative url="https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/content-hub/product-overview" tooltip="Vaya a Content Hub en Experience League"} |
| **Adobe Journey Optimizer** | No aplicable | Disponible para obtener conocimientos del producto y perspectivas operativas. | No | [!BADGE Más información]{type=Informative url="https://experienceleague.adobe.com/en/docs/journey-optimizer/using/get-started/ai-assistant" tooltip="Obtenga información sobre el asistente de IA en AJO"} |
| | | _AJO Prime_ y _Ultimate_ ofrecen [generación de contenido](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/content-management/ai-assistant/gs-generative?lang=en) para ofrecer sugerencias de variación de contenido proactivas para texto e imágenes. | Sí | [!BADGE Más información]{type=Informative url="https://experienceleague.adobe.com/en/docs/journey-optimizer/using/content-management/ai-assistant/gs-generative" tooltip="Obtenga información sobre el asistente de IA en AJO"} |
| **Adobe Journey Optimizer B2B edition** | No aplicable | Disponible para ayudarle con el conocimiento del producto. | No | [!BADGE Más información]{type=Informative url="https://experienceleague.adobe.com/en/docs/journey-optimizer-b2b/user/ai-assistant/ai-assistant-overview" tooltip="Obtenga información sobre el asistente de IA en AJO"} |
| **[!DNL Campaign]servicios administrados en la nube** | No aplicable | Disponible para que el acelerador de contenido genere automáticamente contenido personalizado, atractivo y eficaz en función de los objetivos de marketing en canales como correo electrónico, SMS y push | Sí | [!BADGE Más información]{type=Informative url="https://experienceleague.adobe.com/en/docs/campaign-web/v8/content/ai-assistant/generative-gs" tooltip="Obtenga información sobre el asistente de IA en AJO"} |
| **[!DNL Customer Journey Analytics]** | GenAI se utiliza con:<ul><li> [Subtítulos inteligentes](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/visualizations/intelligent-captions?lang=en): Para obtener información sobre las visualizaciones de Workspace que se usan con más frecuencia.</li><li>[Content Analytics](https://experienceleague.adobe.com/en/docs/analytics-platform/using/content-analytics/report/report?lang=en#template): para asignar metadatos de recursos automáticamente.</li></ul> | Disponible para:<ul><li>[Conocimiento del producto](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/ai-assistant?lang=en) (Experience League)</li><li>[Agente de soporte técnico](https://experienceleague.adobe.com/en/docs/experience-platform/ai-assistant/new-features/customer-support?lang=en) </li><li>[Data Insights Agent](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/data-analysis-ai)</li></ul> | No | [!BADGE Más información]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/visualizations/intelligent-captions" tooltip="Más información sobre los Subtítulos inteligentes"} |
| **Real-Time CDP** | No aplicable | Disponible para obtener información sobre el producto en Experience League. También ofrece perspectivas operativas (en versión beta). | No | [!BADGE Más información]{type=Informative url="https://experienceleague.adobe.com/es/docs/experience-platform/ai-assistant/home" tooltip="Más información sobre Real-Time CDP"} |
| **[!DNL Marketo]** | GenAI está disponible en los [seminarios web interactivos](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/dynamic-chat/generative-ai/overview?lang=en), y en Email Designer (con Firefly) y [Dynamic Chat](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/events/interactive-webinars/gen-ai?lang=en). | Disponible en Marketo Engage [Email Designer](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/email-marketing/email-designer/ai-assistant) | Sí | [!BADGE Más información]{type=Informative url="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/events/interactive-webinars/gen-ai?lang=en" tooltip="Obtenga información sobre la IA en Marketo"} |
| **[!DNL Workfront]** | GenAI se usa con información y sugerencias de [en la aplicación](https://experienceleague.adobe.com/en/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en). | No aplicable | Sí | [!BADGE Más información]{type=Informative url="https://experienceleague.adobe.com/en/docs/workfront/using/basics/ai-assistant/ai-assistant-overview" tooltip="Obtenga información sobre el asistente de IA en Workfront"} |

## Cómo puede utilizar GenAI en Experience Cloud {#products}
...
[!BADGE Más información]{type=Informative url="https://experienceleague.adobe.com/en/docs/journey-optimizer/using/get-started/ai-assistant" tooltip="Obtenga información sobre el asistente de IA en AJO"}
