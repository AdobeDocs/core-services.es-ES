...
source-git-commit: 246ff98f98f34f82cd320100718649486dea0f6f
workflow-type: tm+mt
...
| **[!DNL Marketo]** | GenAI está disponible en [Dynamic Chat](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/dynamic-chat/generative-ai/overview?lang=en) y en [seminarios web interactivos](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/events/interactive-webinars/gen-ai?lang=en). | El asistente de IA de [Email Designer](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/email-marketing/email-designer/ai-assistant) de Marketo Engage le ayuda a crear correos electrónicos contemporáneos, eficaces e intuitivos. | Sí | [!BADGE Más información]{type=Informative url="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/events/interactive-webinars/gen-ai?lang=en" tooltip="Obtenga información sobre la IA en Workfront"} |
