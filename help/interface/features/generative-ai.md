...
source-git-commit: 11ed428fe01af91fdd4a5512f300fcd0c3953d85
workflow-type: tm+mt
...
Este es un resumen de las aplicaciones de Experience Cloud que utilizan GenAI, AI Assistant o IA auténtica. Se indica la compatibilidad con [Adobe Firefly](https://business.adobe.com/products/firefly-business/firefly-ai-approach.html).

| **Nombre de producto** | **IA generativa** | **Asistente de IA** | **Compatibilidad de Firefly** |
|------------------|-------------------------|------------------|-------------------|
