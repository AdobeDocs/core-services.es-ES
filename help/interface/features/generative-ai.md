...
description: Encuentre ayuda sobre la IA generativa (GenAI) y el Asistente de IA en aplicaciones de Experience Cloud.
...
source-git-commit: 1b7758c3ee69d8d972149d2cf03fa3962f1b0494
workflow-type: tm+mt
...
* **Generar una respuesta:** AI proporciona una respuesta o una reacción a una solicitud, basándose normalmente en los datos disponibles y en los repositorios de conocimientos.
  ...
  GenAI contrasta con [IA auténtica](agentic-ai.md) (el marco agéntico de Adobe), que hace referencia a la IA que funciona de forma autónoma.
